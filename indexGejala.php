...
$queryGejala = mysqli_query($koneksi, "SELECT * FROM symptoms");
...
$jumlahSolusi = mysqli_query($koneksi, "SELECT COUNT('solusi_id') as jml_solusi FROM solusi");
        ...
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                        <a class="badge badge-pill badge-primary" href="ubahGejala.php?id_gejala=<?php echo $data["symptom_id"]; ?>">Edit</a> |
                        <a href="function.php?act=hapusGejala&id_gejala=<?= $data['symptom_id']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">Hapus</a>
                        </td>
